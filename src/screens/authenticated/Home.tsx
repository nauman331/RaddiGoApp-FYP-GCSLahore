    ...
    return (
        <View className='bg-white rounded-2xl p-2 flex-1'>
            ...
            <View className='flex-row justify-between my-4 px-2'>
                ...
                <View className='bg-white rounded-2xl p-4 flex-1 ml-2 shadow-sm border-2' style={{ borderColor: iscollector ? '#10b981' : '#f59e0b' }}>
                    <Text className='text-lg font-bold mb-2' style={{ color: iscollector ? '#10b981' : '#f59e0b' }}>
            ...
            <View className='flex-1 justify-center items-center px-2 mb-16'>
                <View className='flex-row justify-between w-full px-2 mb-4'>
                    <Text className='font-bold text-gray-800 text-lg'>
                        {iscollector ? 'My Requests' : 'My Orders'}
                    </Text>
                ...
                <View className='border border-gray-200 rounded-2xl p-6 w-full items-center'>
                    ...
                    <Text className='text-gray-600 text-lg font-semibold'>
                        {iscollector ? 'No Requests Available' : 'No Orders Available'}
                    </Text>
